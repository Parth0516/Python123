...
if os.path.isfile('sqlite.db'):
    ...
    ''')
    cur.execute('''INSERT INTO Account values(1001,'Paryanshu','Sharma',"2001-10-11",1000,"125356278654","1234")''')
    cur.execute('''INSERT INTO Account values(1002,'Anushka','Jain',"1998-11-01",1200,"154328629874","4321")''')
    cur.execute('''INSERT INTO Account values(1003,'Rita','Mittal',"2000-11-07",2000,"652987153076","7777")''')
...
def menu():
    print("Choose the task from the menu \n","-"*5,"1. Pin Change \n","-"*5,"2. Money Transfer \n","-"*5,"3. Withdraw Money \n","-"*5,"4. Print Statement \n","-"*5,"5. Transaction Log")
